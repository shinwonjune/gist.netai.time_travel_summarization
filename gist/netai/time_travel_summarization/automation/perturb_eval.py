...
조건 매트릭스 (docs/교란기_오류모델_조사.md v0 스코프):
    g10/g25/g50            gaussian σ=10/25/50 (접촉 판정 거리 2r 대비 — 규약별로
                           v1 71.7 / regime2 63.7 / regime3 60.0)
    ...
    dsr20/10/5/2/1         시간 기반 다운샘플의 실측 주기 20/10/5/2/1Hz
                           (옛 이름 ds*는 소스 주기를 30Hz로 오인해 실측이 라벨의
                            2배였다 — CONDITIONS 주석 참조)
